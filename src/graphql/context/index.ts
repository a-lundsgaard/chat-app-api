...
let _TOKEN_SECRET: string | undefined = process.env.JWT_SECRET;
let _TOKEN_SECRET_VERIFICATION_KEY: string | undefined = process.env.JWT_SECRET_VERIFICATION_KEY;
let _TOKEN_EXPIRATION: string | undefined = process.env.JWT_TOKEN_EXPIRATION || "1d";
let _UNAUTHORIZED_USER_MESSAGE = "Invalid Key";
...
export default (req: Request): { signIn: () => string, authenticate: () => boolean } => {
